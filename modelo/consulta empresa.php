...
Public function createEmpresaModel($datosModel, $tabla){
    ...
    correo_empresa,contraseña_empresa,foto,fk_rolid_rol,fk_empresa_rol, created) VALUES (:id_empresa,:nit_empresa,
    :tel_empresa,:tel_empresa2,:nom_empresa, :correo_empresa,:contraseña_empresa,:foto,:fk_rolid_rol,:fk_empresa_rol, :created)");
 ...
 public function readEmpresaModel($tabla){
    ...
    return $usuarios;
     ...
     public function deleteEmpresaModel($id_empresa, $tabla){
        $stmt =  ConexionDb::Conex()->prepare("DELETE FROM $tabla WHERE id_empresa = : id_empresa";
        $stmt->execute()){
     ...
     public function loginEmpresaModel($datosModel, $tabla){
        $stmt =  ConexionDb::Conex()->prepare("SELECT id_empresa,nom_empresa,contraseña_empresa,created FROM $tabla WHERE nom_empresa = :nom_empresa AND
